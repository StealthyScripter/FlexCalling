...
let contacts: Contact[] = [
  ...
  { id: '2', name: 'Bob Williams', phone: '+254722456789', favorite: false, avatarColor: '#3B82F6' },
  { id: '3', name: 'Carol Davis', phone: '+254734564890', favorite: true, avatarColor: '#F59E0B' },
  { id: '4', name: 'David Brown', phone: '+254745678301', favorite: false, avatarColor: '#8B5CF6' },
  { id: '5', name: 'Ali John', phone: '+254712340678', favorite: true, avatarColor: '#EC4899' },
  { id: '6', name: 'Bobby Will', phone: '+254723450789', favorite: false, avatarColor: '#3B82F6' },
  { id: '7', name: 'Carl David', phone: '+254734587890', favorite: true, avatarColor: '#F59E0B' },
  { id: '8', name: 'Dave Bro', phone: '+254744678901', favorite: false, avatarColor: '#8B5CF6' },
];
...
let callLogs: CallUIData[] = [
  ...
  },
  {
    ...
    incomingCallInvite: null,
    callStartTime: new Date(Date.now() - 60 * 1000),
    callDuration: 540,
    ratePerMinute: 0.15,
    estimatedCost: 1.35,
  },
  {
    ...
    incomingCallInvite: null,
    callStartTime: new Date(Date.now()),
    callDuration: 540,
    ratePerMinute: 0.15,
    estimatedCost: 1.35,
  },
